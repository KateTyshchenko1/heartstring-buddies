  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 py-8 sm:py-16">
      <motion.div 
        ...
        className="max-w-[1400px] mx-auto bg-white/90 backdrop-blur-sm rounded-3xl p-8 sm:p-12 shadow-xl text-center"
      >
        <h2 className="text-lg sm:text-xl md:text-2xl font-display mb-8 text-[#D91F3A] leading-tight">
          Experience the Difference Today
        </h2>
        <p className="text-sm md:text-base text-gray-600 mb-12 leading-relaxed max-w-[900px] mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-6 mb-12 max-w-[1200px] mx-auto">
        ...
        <div className="bg-gradient-to-r from-cream-soft via-primary-soft to-cream-soft rounded-2xl p-8 mb-12 max-w-[900px] mx-auto">
